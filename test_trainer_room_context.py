...
ЧТО ЗДЕСЬ ДОКАЗЫВАЕТСЯ И ЧТО НЕТ. Карточка живого набора печатает владельцу «урок ложится в базу
уроков ЖИВОГО набора и на ответы бота НЕ действует». Первая половина фразы — про базу и верна;
